...
using Tugure.Solusindo.DemoUiComponents.Dto;

namespace Tugure.Solusindo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : SolusindoAppServiceBase, IDemoUiComponentsAppService
    {
