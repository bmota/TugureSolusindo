...
using Tugure.Solusindo.Net.MimeTypes;
using OfficeOpenXml;

namespace Tugure.Solusindo.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : SolusindoServiceBase, ITransientDependency
    {
