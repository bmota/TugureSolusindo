...
using Tugure.Solusindo.Authorization.Users.Profile.Cache;
using Tugure.Solusindo.Authorization.Users.Profile.Dto;
using Tugure.Solusindo.Friendships;
using Tugure.Solusindo.Identity;
using Tugure.Solusindo.Security;
using Tugure.Solusindo.Storage;
using Tugure.Solusindo.Timing;

namespace Tugure.Solusindo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : SolusindoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Tugure.Solusindo",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Tugure.Solusindo",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
