...
using Tugure.Solusindo.Authorization.Permissions;
...
using Tugure.Solusindo.Authorization.Users.Exporting;
...
namespace Tugure.Solusindo.Authorization.Users
{
    ...
    public class UserAppService : SolusindoAppServiceBase, IUserAppService
    {
