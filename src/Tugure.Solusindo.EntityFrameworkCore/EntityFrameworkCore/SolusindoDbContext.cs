...
{
    public class SolusindoDbContext : AbpZeroDbContext<Tenant, Role, User, SolusindoDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public SolusindoDbContext(DbContextOptions<SolusindoDbContext> options)
            : base(options)
        {
