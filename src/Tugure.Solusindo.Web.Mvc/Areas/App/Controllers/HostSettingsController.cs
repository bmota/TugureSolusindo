...
using Tugure.Solusindo.Configuration.Host;
using Tugure.Solusindo.Editions;
using Tugure.Solusindo.Timing;
using Tugure.Solusindo.Timing.Dto;
using Tugure.Solusindo.Web.Areas.App.Models.HostSettings;
...
namespace Tugure.Solusindo.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : SolusindoControllerBase
    {
