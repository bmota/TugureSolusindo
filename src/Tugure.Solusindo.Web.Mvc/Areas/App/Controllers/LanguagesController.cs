...
using Tugure.Solusindo.Web.Areas.App.Models.Languages;
...
namespace Tugure.Solusindo.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : SolusindoControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = SolusindoConsts.LocalizationSourceName;
            }
