...
(function ($) {
    ...
    app.UserNotificationHelper = (function () {
        ...
        return function () {
            ...
            /* Example:
            abp.notifications.messageFormatters['Tugure.Solusindo.MyNotificationDataType'] = function(userNotification) {
...
(function () {
    ...
    var appLocalizationSource = abp.localization.getSource('Solusindo');
