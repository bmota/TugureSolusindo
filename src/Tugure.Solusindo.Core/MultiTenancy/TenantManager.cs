...
using Tugure.Solusindo.MultiTenancy.Demo;
...
namespace Tugure.Solusindo.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(SolusindoConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
