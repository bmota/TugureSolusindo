...
namespace Tugure.Solusindo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : SolusindoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Tugure.Solusindo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
