...
using Tugure.Solusindo.Web.Public.Startup;
using Tugure.Solusindo.Web.Session;

namespace Tugure.Solusindo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : SolusindoViewComponent
    {
