...
using Tugure.Solusindo.Web.Authentication.JwtBearer;
using Tugure.Solusindo.Web.Authentication.TwoFactor;
using Tugure.Solusindo.Web.Configuration;
#if FEATURE_SIGNALR
using Abp.Web.SignalR;
#endif

namespace Tugure.Solusindo.Web
{
    [DependsOn(
    ...
    public class SolusindoWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SolusindoWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(SolusindoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SolusindoWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(SolusindoWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
