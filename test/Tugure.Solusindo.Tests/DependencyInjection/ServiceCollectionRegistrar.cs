...
namespace Tugure.Solusindo.Tests.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<SolusindoDbContext>>()
                    .Instance(builder.Options)
                    .LifestyleSingleton()
            );

            inMemorySqlite.Open();
            new SolusindoDbContext(builder.Options).Database.EnsureCreated();
        }
